...
\vspace{5mm}\newline
Para lograr el quinto objetivo \textbf{(Evaluar las recomendaciones emitidas por el sistema de recomendación conforme a la realimentación de los usuarios de la aplicación..)}.........
\vspace{5mm}\newline
\textbf{Las tecnologías usadas en el desarrollo del proyecto fueron:}
\begin{itemize}
    \item Android: Android \cite{26} es un sistema operativo móvil desarrollado por Google, basado en el Kernel de Linux y otros software de código abierto.
    \item Java: Java \cite{27} es un lenguaje de programación de propósito general, concurrente y orientado a objetos.
    \item Python: Python \cite{28} es un lenguaje de programación interpretado, usa tipado dinámico y es multiplataforma.
    \item PostgreSQL: PostgreSQL \cite{29} es un motor de base de datos libre, robusto y proporciona buenos niveles de seguridad.
    \item Django: Django \cite{30} es un framework de aplicaciones web de alto nivel que fomenta el desarrollo rápido y el diseño limpio y pragmático.
    \item ReactJS: React \cite{31} es una biblioteca Javascript para crear interfaces de usuario.
    \item Scikit-learn: Scikit-learn \cite{32} es una biblioteca para machine learning, para el lenguaje de programación Python.
    \item Numpy: Numpy \cite{33} es una extensión de Python, que le agrega mayor soporte para vectores y matrices, constituyendo una biblioteca de funciones matemáticas de alto nivel para operar con esos vectores o matrices.
    \item Firebase: Firebase \cite{34} es una plataforma para el desarrollo de aplicaciones web y aplicaciones móviles.
    \item Pusher: Pusher \cite{35} permite a los desarrolladores con APIs crear funciones de colaboración y comunicación en sus aplicaciones web y móviles.
\end{itemize}
...
Los demás pruebas de sistema realizados las puede detallar en el documento Anexo, Apéndice D.
...
\bibitem{26} Google, “Android,” 2019.

\bibitem{27} ORACLE, “Java,” 2019. [Online]. Available: https://www.oracle.com/es/java/.

\bibitem{28} “Python,” 2019. [Online]. Available: https://www.python.org/.

\bibitem{29} “PosgreSQL,” 2019. [Online]. Available: https://www.postgresql.org/.

\bibitem{30} “Django,” 2019. [Online]. Available: https://www.djangoproject.com/.

\bibitem{31} “ReactJS,” 2019. [Online]. Available: https://es.reactjs.org/docs/getting-started.html/ .

\bibitem{32} “Scikit-learn,” 2019. [Online]. Available: https://scikit-learn.org/.

\bibitem{33} “Numpy,” 2019. [Online]. Available: http://www.numpy.org/.

\bibitem{34} “Firebase,” 2019. [Online]. Available: https://firebase.google.com/.

\bibitem{35} “Pusher,” 2019. [Online]. Available: https://pusher.com/.
